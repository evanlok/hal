class Admin::ScenesController < Admin::BaseController
  ...
  def preview
    ...
    scene_preview_video = Engine::Definitions::ScenePreviewVideo.new(params[:scene_vgl], scene_data, width: params[:width], height: params[:height], background: params[:background])
