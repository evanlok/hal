class Admin::CoreLogicLocationsController < Admin::BaseController
  ...
  def create
    ...
    if @core_logic_location.save
      redirect_to admin_core_logic_location_url(@core_logic_location), notice: "Created location: #{@core_logic_location.zip_code}"
    else
      render :new
    end
  end
  ...
  def update
    if @core_logic_location.update_attributes(core_logic_location_params)
      redirect_to admin_core_logic_location_url(@core_logic_location), notice: "Updated location: #{@core_logic_location.zip_code}"
    else
      render :edit
    end
  end
  ...
  def destroy
    ...
    redirect_to admin_core_logic_locations_url, notice: "Deleted location: #{@core_logic_location.zip_code}"
  end
